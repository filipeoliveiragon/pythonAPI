...
from tbr_api.schemas.atividade_schema import Atividade, AtividadeCreate, AtividadePatch, AtividadePut

from tbr_api.crud.atividade_crud import deletaAtividade, listaUsuarioAtividade, listarAtividades, criaAtividade, listaAtividade, editaAtividadePut
